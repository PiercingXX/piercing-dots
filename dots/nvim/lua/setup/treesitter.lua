...
local languages = {
  "lua","sql","go","regex","bash","markdown","markdown_inline","yaml","json","jsonc","cpp","csv","java","javascript","python","dockerfile","html","css","templ","php","promql","glsl",
}

-- latex parser is skipped due to tree-sitter CLI incompatibility with --no-bindings
