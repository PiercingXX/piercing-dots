...
This file is auto-generated by ~/.config/opencode/design/scripts/generate-design-catalog.mjs.
Do not edit this file manually.

Generated: 2026-07-09T19:40:36.862Z

Catalog location: ~/.config/opencode/design/DESIGN-CATALOG.md
...
Source directory: ~/.config/opencode/design/design-systems
...
Source directory: ~/.config/opencode/design/design-skills
...
Source directory: ~/.config/opencode/skills
...
| magazine-web-ppt | 生成"电子杂志 × 电子墨水"风格的横向翻页网页 PPT（单 HTML 文件），含 WebGL 流体背景、衬线标题 + 非衬线正文、章节幕封、数据大字报、图片网格等模板。当用户需要制作分享 / 演讲 / 发布会风格的网页 PPT，或提到"杂志风 PPT"、"horizontal swipe deck"、"editorial magazine"、"e-ink presentation"时使用。 |
...
1. Read design system tokens from ~/.config/opencode/design/design-systems/<brand>/DESIGN.md.
2. Optionally apply aesthetic rules from ~/.config/opencode/design/design-skills/<style>/SKILL.md.
3. Build with design-pack workflow structure from ~/.config/opencode/skills/<skill>/SKILL.md and assets/template.html.
